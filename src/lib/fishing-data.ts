...
export const fishGuides: FishGuide[] = [
  {
    ...
    gear: ["2.7-3.0 m rod", "2500-3000 reel", "thin braid", "fluorocarbon leader", "waders and belt"],
  ...
  },
  {
    ...
    gear: ["2.1-2.4 m heavy spinning rod", "4000 reel", "strong braid", "wire or heavy fluorocarbon trace", "long pliers"],
  ...
  },
  {
    ...
    gear: ["1.8-2.1 m light spinning rod", "1000-2500 reel", "thin braid", "light fluorocarbon leader"],
  ...
  },
  {
    ...
    gear: ["3.0-3.3 m pier rod", "4000-5000 reel", "heavier braid", "jigs or bottom rigs"],
  ...
  },
  {
    ...
    gear: ["3.0-3.6 m surf or pier rod", "4000-5000 reel", "two-hook rigs", "60-100 g sinkers"],
