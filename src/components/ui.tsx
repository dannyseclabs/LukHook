...
const buttonVariants: Record<Variant, string> = {
  primary: "border border-copper bg-copper text-ink shadow-[0_14px_34px_rgb(193_18_31_/_0.18)] hover:border-copper-light hover:bg-copper-light",
  secondary: "border border-channel/35 bg-paper/45 text-ink shadow-[inset_0_1px_0_rgb(253_240_213_/_0.06)] hover:border-channel/60 hover:bg-channel/10",
...
export function StatCard({ label, value, className }: { label: string; value: string | number; className?: string }) {
  return (
    <div className={cn("rounded-lg border border-channel/18 bg-channel/8 px-4 py-3", className)}>
